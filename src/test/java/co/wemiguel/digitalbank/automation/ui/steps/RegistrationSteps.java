...
public class RegistrationSteps {
   ...
   //  driver.manage().timeouts().implicitlyWait(7, TimeUnit.SECONDS);
      ...
      //  List<Map<String, Object>> nextValList = ne
...
//    @When("User creates account with following fields")
//    public void user_creates_account_with_following_fields(List<Map<String, String>> registrationTestDataListMap) {
//        registrationPage.filOutRegistrationForm(registrationTestDataListMap);
//@When("User creates account with following fields")
//public void user_creates_account_with_following_fields(List<Map<String, String>> registrationTestDataListMap) {
//    registrationPage.fillOutTheRegistrationPage(registrationTestDataListMap);
    }
    ...
    public void theFollowingUserInfoShouldBeSavedInTheDb(List<Map<String, String>> expectedUserProfileInfoInDBList) {
     ...
     //  List<Map<String, Object>> nextValList =  DBUtils.runSQLSelectQuery(queryToGetNextValInHibernateSeqTable);
...
//        assertEquals(expectedUserInfoMap.get("enabled"), String.valueOf(actualUserProfileInfoMap.get("enabled")), "account enabled mismatch upon registration");
//        assertEquals(expectedUserInfoMap.get("email"), actualUserProfileInfoMap.get("username"), "account username mismatch upon registration");
       ...
       // assertEquals(nextValList,actualUserInfoMap.get("id"), "ID mismatch");
...
//        assertEquals(++expectedUserProfileId, actualUserProfileInfoMap.get("id"), "ID mismatch");
    ...
    @Given("The the user with {string} is not in DB")
    public void theTheUserWithIsNotInDB(String email) {
     ...
     //   List<Map<String, Object>> nextValList =  DBUtils.runSQLSelectQuery(queryToGetNextValInHibernateSeqTable);
      nextValList = DBUtils.runSQLSelectQuery(queryToGetNextValInHibernateSeqTable);
       ...
       // nextValList = String queryToGetNextValInHibernateSeqTable = String.format("select * from hibernate_sequence");
   //    List<Map<String, Object>> nextValList = DBUtils.runSQLSelectQuery(queryToGetNextValInHibernateSeqTable);
